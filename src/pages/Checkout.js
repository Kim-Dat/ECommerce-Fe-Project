    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            const data = {
                ...
                totalPriceAfterDiscount: totalAmount + shipping,
                ...
                <div className="row">
                    <div className="col-7">
                        <div className="checkout-left-data">
                            ...
                            <form className="d-flex flex-wrap justify-content-between gap-3" action="" onSubmit={formik.handleSubmit}>
                                <div className="w-100">
                                    <div>
                                        <CustomInput type={"text"} name={"fullName"} c_class={"py-3 fs-4"} placeholder={"full Name"} onCh={formik.handleChange("fullName")} onBl={formik.handleBlur("fullName")} val={formik.values.fullName} />
                                        <div className="error ms-3">{formik.touched.fullName && formik.errors.fullName}</div>
                                    </div>
                                </div>
                                <div className="w-100">
                                    <div>
                                        <CustomInput type={"text"} name={"city"} c_class={"py-3 fs-4"} placeholder={"City"} val={formik.values.city} onCh={formik.handleChange("city")} onBl={formik.handleBlur("city")} />
                                        <div className="error ms-3">{formik.touched.city && formik.errors.city}</div>
                                    </div>
                                </div>
                                <div className="w-100">
                                    <div>
                                        <CustomInput type={"text"} name={"address"} c_class={"py-3 fs-4"} placeholder={"Address"} onCh={formik.handleChange("address")} onBl={formik.handleBlur("address")} val={formik.values.address} />
                                        <div className="error ms-3">{formik.touched.address && formik.errors.address}</div>
                                    </div>
                                </div>
                                <div className="flex-grow-1">
                                    <div>
                                        <CustomInput type={"text"} c_class={"py-3 fs-4"} name={"phone"} placeholder={"phone"} val={formik.values.phone} onCh={formik.handleChange("phone")} onBl={formik.handleBlur("phone")} />
                    ...
                    <div className="col-5">
                        ...
                        <div className="line-border-bottom ">
                            <div className="d-flex justify-content-between align-item-center p-2 fs-3">
                            ...
                            <div className="d-flex justify-content-between align-item-center pt-2 px-2 fs-3">
                                <p className="total">Phí giao hàng :</p>
                        ...
                        <div className="d-flex justify-content-between align-item-center py-4 px-2 text-danger">
                            <p className="total fs-3">Total : </p>
                            <p className="total-price fs-1">{formattedAmount(totalAmount + shipping)}</p>
                        </div>
                    </div>
                </div>
            </Container>
